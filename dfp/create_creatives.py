...
def create_creative_config(name, advertiser_id, prebid_creative_snippet):
    """
    ...
    snippet_file_path = os.path.join(os.path.dirname(__file__), '../', prebid_creative_snippet)
...
def create_duplicate_creative_configs(bidder_code, order_name, advertiser_id,
                                      prebid_creative_snippet, num_creatives=1):
    """
    ...
    for creative_num in range(1, num_creatives + 1):
        config = create_creative_config(
            ...
            prebid_creative_snippet=prebid_creative_snippet
        )
