...
class NewPrebidPartnerTests(TestCase):
  ...
  def tearDown(self):
    ...
    # https://developers.google.com/doubleclick-publishers/docs/reference/v201811/CustomTargetingService.DeleteCustomTargetingKeys
    # https://developers.google.com/doubleclick-publishers/docs/reference/v201811/CustomTargetingService.DeleteCustomTargetingValues
